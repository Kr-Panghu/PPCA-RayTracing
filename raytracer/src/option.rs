...
use crate::material;
use crate::objects::*;
use crate::objects::aarect;
//use crate::objecblock;
use crate::BVH::bvh;
...
fn standard_cornell_box() -> scene::hittable_list {
    ...
    objects.add( Arc::new( scene::flip_face::new(
        Arc::new(aarect::xz_rect::new(light.clone(), 213.0, 343.0, 227.0, 332.0, 554.0)))
    ));
    objects.add(Arc::new(aarect::xz_rect::new(white.clone(), 0.0, 555.0, 0.0, 555.0, 0.0)));
    objects.add(Arc::new(aarect::xz_rect::new(white.clone(), 0.0, 555.0, 0.0, 555.0, 555.0)));
    ...
    //objects.add(Arc::new(scene::Sphere::new(Point3::new(0.0,1.0,0.0), 0.01, Arc::new(material::lambertian::new(&Vec3::new(0.0, 0.0, 0.0))))));
    ...
    //objects.add(Arc::new(scene::Sphere::new(Point3::new(0.0,2.0,0.0), 0.01, Arc::new(material::lambertian::new(&Vec3::new(0.0, 0.0, 0.0))))));
    //objects.add(Arc::new(scene::Sphere::new(Point3::new(0.0,0.0,0.0), 0.01, Arc::new(material::lambertian::new(&Vec3::new(0.0, 0.0, 0.0))))));
    objects
}
